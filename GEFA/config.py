...
PRED_BATCH_SIZE = 256           # Number of samples for one prediction batch
run_model = 0                   # 0 for GEFA, 1 for GLFA
cuda = 0                        # GPU used
setting = 0                     # Setting number, 0, 1, 2 or 3
LR = 0.0005                     # Learning Rate
dataset = 'davis'                # dataset used for training
pred_dataset = 'pred'          # The dataset on which predictions are to be made.
...
mode = 2                        # 0 for training, 1 for evaluating trained model on test data, 2 for getting predictions on new data
