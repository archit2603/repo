...
export HHDIR=$ModelingHome/data/RaptorXCommon/HHblits/hhsuite-3.3.0-SSE2-Linux
...
export HHDB=$ModelingHome/data/RaptorXCommon/HHblits/DB/uniref30_2020_06/UniRef30_2020_06
