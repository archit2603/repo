...
if model_common_hp_dict["model"] == "MNN":
    """ MNN hyperparameters:
...
elif model_common_hp_dict["model"] == "S2V":
    """ S2V hyperparameters:
...
elif model_common_hp_dict["model"] == "AttS2V":
...
elif model_common_hp_dict["model"] == "GGNN":
...
elif model_common_hp_dict["model"] == "AttGGNN":
    """ AttGGNN hyperparameters:
      att_depth (int) : Num layers in 'att_nns' MLP (message aggregation step).
      att_dropout_p (float) : Dropout probability in 'att_nns' MLP (message aggregation step).
      att_hidden_dim (int) : Number of weights (layer width) in 'att_nns' MLP (message
        aggregation step).
      mlp1_depth (int) : Num layers in first-tier MLP in `APDReadout`.
      mlp1_dropout_p (float) : Dropout probability in first-tier MLP in `APDReadout`.
      mlp1_hidden_dim (int) : Number of weights (layer width) in first-tier MLP in `APDReadout`.
      ...
      gather_att_depth (int) : Num layers in 'gather_att' MLP in `GraphGather`.
      gather_att_dropout_p (float) : Dropout probability in 'gather_att' MLP in `GraphGather`.
      gather_att_hidden_dim (int) : Number of weights (layer width) in 'gather_att' MLP
        in `GraphGather`.
      gather_emb_depth (int) : Num layers in 'gather_emb' MLP in `GraphGather`.
      gather_emb_dropout_p (float) : Dropout probability in 'gather_emb' MLP in `GraphGather`.
      gather_emb_hidden_dim (int) : Number of weights (layer width) in 'gather_emb' MLP
        in `GraphGather`.
      gather_width (int) : Output size of `GraphGather` block.
      message_passes (int) : Number of message passing steps.
      message_size (int) : Size of message passed (output size of all MLPs in message
      ...
      msg_dropout_p (float) : Dropout probability in 'msg_nns' MLP (message aggregation step).
      msg_hidden_dim (int) : Number of weights (layer width) in 'msg_nns' MLP (message
        aggregation step).
    """
    model_specific_hp_dict = {
        "att_depth": 4,
...
elif model_common_hp_dict["model"] == "EMN":
    """ EMN hyperparameters:
      att_depth (int) : Num layers in 'att_msg_nn' MLP (edge propagation step).
      att_dropout_p (float) : Dropout probability in 'att_msg_nn' MLP (edge propagation step).
      att_hidden_dim (int) : Number of weights (layer width) in 'att_msg_nn' MLP (edge
        propagation step).
      edge_emb_depth (int) : Num layers in 'embedding_nn' MLP (edge processing step).
      edge_emb_dropout_p (float) : Dropout probability in 'embedding_nn' MLP (edge processing step).
      edge_emb_hidden_dim (int) : Number of weights (layer width) in 'embedding_nn' MLP
        (edge processing step).
      edge_emb_size (int) : Output size of all MLPs in edge propagation and processing steps
        (input size to `GraphGather`).
      mlp1_depth (int) : Num layers in first-tier MLP in `APDReadout`.
      mlp1_dropout_p (float) : Dropout probability in first-tier MLP in `APDReadout`.
      mlp1_hidden_dim (int) : Number of weights (layer width) in first-tier MLP in `APDReadout`.
      mlp2_depth (int) : Num layers in second-tier MLP in `APDReadout`.
      ...
      msg_dropout_p (float) : Dropout probability in 'emb_msg_n' MLP (edge propagation step).
      msg_hidden_dim (int) : Number of weights (layer width) in 'emb_msg_nn' MLP (edge
        propagation step).
    """
    model_specific_hp_dict = {
        "att_depth": 4,
